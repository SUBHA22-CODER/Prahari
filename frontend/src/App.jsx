  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen bg-slate-100 flex flex-col font-sans relative">
        ...
        {toast && (
          <div className="fixed top-16 right-4 z-50 max-w-md w-full bg-slate-900 text-white p-4 rounded-lg shadow-2xl border-2 border-emerald-500 transition-all duration-300 transform translate-y-0 animate-bounce">
            <div className="flex items-start space-x-3">
              <div className="p-2 bg-emerald-500/20 text-emerald-400 rounded-full flex-shrink-0 mt-0.5">
                <BellRing className="w-5 h-5 animate-pulse" />
              </div>
              <div className="flex-1 space-y-1 text-xs">
                <div className="flex justify-between items-center">
                  <span className="font-extrabold text-emerald-400 uppercase tracking-wider text-[11px] flex items-center space-x-1">

  ...
  events: [
    {
      ...
      timeline: [
        ...
        { time: '2024-07-29 08:00', risk_score: 74, rainfall_mm: 310, threshold: 70, is_threshold_cross: true, note: 'Critical Threshold 70 Crossed' },
        ...
        { time: '2024-07-30 02:00', risk_score: 96, rainfall_mm: 510, threshold: 70, is_event_time: true, note: 'Official Event Occurred / Disaster Confirmed' },
    ...
    {
      id: 'kerala-2018',
      title: 'Kerala Great Floods (August 2018)',
      district: 'Wayanad / Kerala',
      critical_threshold: 70,
      critical_crossed: true,
      lead_time_hours: 36,
      official_event_time: '2018-08-15T10:00:00Z',
      critical_crossed_time: '2018-08-13T22:00:00Z',
      summary: 'PRAHARI-AI backtest proves severe multi-district risk fusion identified critical overflow conditions 36 hours before dam gate emergencies.',
      timeline: [
        { time: '2018-08-12 00:00', risk_score: 30, rainfall_mm: 45, threshold: 70 },
        { time: '2018-08-12 12:00', risk_score: 45, rainfall_mm: 110, threshold: 70 },
        { time: '2018-08-13 00:00', risk_score: 56, rainfall_mm: 180, threshold: 70 },
        { time: '2018-08-13 12:00', risk_score: 65, rainfall_mm: 240, threshold: 70 },
        { time: '2018-08-13 22:00', risk_score: 72, rainfall_mm: 310, threshold: 70, is_threshold_cross: true, note: 'Critical Threshold Crossed' },
        { time: '2018-08-14 12:00', risk_score: 84, rainfall_mm: 420, threshold: 70 },
        { time: '2018-08-15 10:00', risk_score: 95, rainfall_mm: 610, threshold: 70, is_event_time: true, note: 'Official Disaster Emergency Declared' }
      ]
    }
  ]
};
